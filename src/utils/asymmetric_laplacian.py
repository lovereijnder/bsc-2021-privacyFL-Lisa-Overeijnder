...
'''Given privacy parameters epsilon, global_sensitivity, and scale parameter k, return the function for the 
...
# Example for getting results for asymmetric laplacian
def asymmetric_laplacian_example():
    epsilon = 1e-4  # change here for different epsilon values
    global_sensitivity = 1  # changes here for different global sensitivity values
